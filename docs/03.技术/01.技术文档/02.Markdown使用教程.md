...
语法：
[![github](https://img.shields.io/badge/xxx.svg)](https://github.com/yemao-zi)
```
...
```markdown
![其他仓库的图片1](https://github.com/yemao-zi/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2](https://raw.githubusercontent.com/yemao-zi/image_store/master/blog/md_logo.png)
