...
语法：
[![github](https://img.shields.io/badge/xxx.svg)](https://github.com/zhushengjie123)
```
...
```html
<img src="https://xxx.png" width="50px" height="30px">
```
...
```markdown
![其他仓库的图片1](https://github.com/zhushengjie123/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2](https://raw.githubusercontent.com/zhushengjie123/image_store/master/blog/md_logo.png)
