...
一开始的部署方式是使用[sh部署脚本](https://github.com/zhushengjie123/vuepress-theme-vdoing/blob/master/deploy.sh)把代码提交到这两个平台的仓库分支，虽然已经很方便了，但是我还想把博客未打包的源码提交到Github主分支上。这就需要我操作两次命令，**我就想能不能只需要一次操作就可以同时把源码、部署代码一次性提交到两个平台呢？**
...
if [ -z "$GITHUB_TOKEN" ]; then
  ...
  githubUrl=https://xugaoyi:${GITHUB_TOKEN}@github.com/zhushengjie123/blog.git
