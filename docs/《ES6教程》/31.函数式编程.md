...
这是很难阅读且不直观的！如果我们能在 JavaScript 中使用实际的管道操作符（`|>`），那就太好了，但实际上我们还不能使用它。他目前还没内置在 JavaScript 中，[正处于 TC39 审议的草案/第1阶段](https://links.jianshu.com/go?to=https%3A%2F%2Ftc39.es%2Fproposal-pipeline-operator%2F%23sec-intro)
