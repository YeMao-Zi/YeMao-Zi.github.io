...
![](https://s2.loli.net/2025/10/16/eRhT8OBNqd1JslL.png)

输入容器名和要映射的端口：

![](https://s2.loli.net/2025/10/16/KwVJPu9jDcYEpCn.png)

这里把宿主机的 81 端口映射到容器内的 80 端口，点击 run。

这时候就可以看到 docker 容器跑起来了，并且打印了日志：

![](https://s2.loli.net/2025/10/16/HvX3kYjsteBLlN6.png)

浏览器访问下 http://localhost:81 可以看到 nginx 欢迎页面：

![](https://s2.loli.net/2025/10/16/zFVUPlI3mj5DkOa.png)

这很明显是容器里跑的服务。

![](https://s2.loli.net/2025/10/16/eVND71amvydC2Ux.png)
...
![](https://s2.loli.net/2025/10/16/HM8tkCKqvWYxAfi.png)

里面的 /usr/share/nginx/html/ 目录下面就是所有的静态文件。

双击点开 index.html 看看：

![](https://s2.loli.net/2025/10/16/uNy6xarWqinIHw8.png)

![](https://s2.loli.net/2025/10/16/FMDR3Wu8ZOHSkLC.png)
...
```
![](https://s2.loli.net/2025/10/16/rWVJ56KMwufRFSH.png)

docker cp 这个命令就是用于在宿主机和容器之间复制文件和目录的。

![](https://s2.loli.net/2025/10/16/s2M8q3ELtReP9xk.png)
...
![](https://s2.loli.net/2025/10/16/WpsSEN5TPxL6Ioa.png)
...
````
![](https://s2.loli.net/2025/10/16/UzQmr73LVpwd2OF.png)

但当目标目录存在的时候，docker 会把他复制到目标目录下面：

![](https://s2.loli.net/2025/10/16/FhoRQrNatBbLUEH.png)

我们需要先删除容器的这个目录，再复制：

![](https://s2.loli.net/2025/10/16/4xcldFLzgPhVRkC.png)
...
![](https://s2.loli.net/2025/10/16/PI6YS3auvyOJZ1G.png)

然后浏览器访问下试试：

![](https://s2.loli.net/2025/10/16/9dLamc8UEKs1xro.png)

![](https://s2.loli.net/2025/10/16/jZkiTlIShnW6fbX.png)
...
![](https://s2.loli.net/2025/10/16/pM9kEo6I4gOKaXL.png)
...
![](https://s2.loli.net/2025/10/16/yfmUvkWjA9qnKe8.png)
...
![](https://s2.loli.net/2025/10/16/EkP1umdb7DcWCiq.png)
...
![](https://s2.loli.net/2025/10/16/YpjfFcBdsXA5OeV.png)
...
![](https://s2.loli.net/2025/10/16/fd9rUBsFc6Zqj2y.png)

然后来看第一条路由：

![](https://s2.loli.net/2025/10/16/MTtYERo7IZPazS9.png)

location 和路径之间加了个 =，代表精准匹配，也就是只有完全相同的 url 才会匹配这个路由。

![](https://s2.loli.net/2025/10/16/VQmsiYSMrGcd4uI.png)

![](https://s2.loli.net/2025/10/16/Fc9GXPUWa6Mr85u.png)

不带 = 代表根据前缀匹配，后面可以是任意路径。

![](https://s2.loli.net/2025/10/16/9dpocRKbZVjxhwC.png)

这里的 $uri 是取当前路径。

![](https://s2.loli.net/2025/10/16/t5njSNywagi1FmX.png)

![](https://s2.loli.net/2025/10/16/anLfVxedEGWFXyk.png)

然后如果想支持正则，就可以加个 ~。

![](https://s2.loli.net/2025/10/16/cEaTFP12Zfw6oOq.png)

这里的正则语法不难看懂，就是 /333/bbb 开头，然后中间是任意字符，最后 .html 结尾的 url。

![](https://s2.loli.net/2025/10/16/NAyQP8HC1MF3D6l.png)

![](https://s2.loli.net/2025/10/16/b9vyzPwEBH3dFoY.png)

但是它是区分大小写的，比如这样就不行了：

![](https://s2.loli.net/2025/10/16/7BaURlu5gAeHomt.png)

换成小写就可以：

![](https://s2.loli.net/2025/10/16/m5CGXcUx1qyOzjw.png)

如果想让正则不区分大小写，可以再加个 \*

![](https://s2.loli.net/2025/10/16/JEpYBKg1zfr98GX.png)

试一下：

![](https://s2.loli.net/2025/10/16/jFADvPxaIkWd8Sc.png)

![](https://s2.loli.net/2025/10/16/OKQVMrzeHUWg7aP.png)
...
![](https://s2.loli.net/2025/10/16/AP3g5lxakdBeY2j.png)

这时候就有两个 /444 的路由了：

![](https://s2.loli.net/2025/10/16/9TV7iUHzkNJxF4u.png)

这时候浏览器访问，还是匹配上面的那个路由：

![](https://s2.loli.net/2025/10/16/fn8WigAuP1IY93p.png)
...
![](https://s2.loli.net/2025/10/16/G7fs5QXda8WgAnR.png)

这时候同一个 url，匹配的就是下面的路由了：

![](https://s2.loli.net/2025/10/16/TF1XVYrJb7uDstp.png)
...
![](https://s2.loli.net/2025/10/16/LlYXSJCMgvO2w93.png)

![](https://s2.loli.net/2025/10/16/2w9NTWQV8pkPFIt.png)

![](https://s2.loli.net/2025/10/16/RHEcpKA6Zxtdnzo.png)
...
![](https://s2.loli.net/2025/10/16/7PMO2vGHV6Z4zp9.png)

![](https://s2.loli.net/2025/10/16/BGsN98eTb1P632q.png)
...
```
![](https://s2.loli.net/2025/10/16/8UFJ6r9ebwQxvuZ.png)
...
npm run start:dev
```
![](https://s2.loli.net/2025/10/16/qa5tpGZPkDB9XVT.png)

浏览器就访问 http://localhost:3000 看到 hello world 就代表 nest 服务跑成功了：

![](https://s2.loli.net/2025/10/16/LNcTxWzdpjIYZtS.png)

添加一个全局的前缀 /api

![](https://s2.loli.net/2025/10/16/xnCyd65VhguTSRU.png)

![](https://s2.loli.net/2025/10/16/nrpj8Zx9MyIeSPc.png)
...
![](https://s2.loli.net/2025/10/16/gKVtQumRAESzliC.png)

也就是这样的：

![](https://s2.loli.net/2025/10/16/DWpMAlrOPG37nmE.png)
...
![](https://s2.loli.net/2025/10/16/nWoLeEd5A3DbwZs.png)
...
![](https://s2.loli.net/2025/10/16/amGMR3i9elBIkKT.png)

然后浏览器访问下。

直接访问 nest 服务的话，是没有这个 header 的：

![](https://s2.loli.net/2025/10/16/gexjVm8M7BEhcoG.png)

![](https://s2.loli.net/2025/10/16/I9iDd7wEslhRyuG.png)

访问 nginx 的反向代理服务器，做一次中转：

![](https://s2.loli.net/2025/10/16/u2jRnf3gvIixhmQ.png)

![](https://s2.loli.net/2025/10/16/rxFeQgjCcW2mdZP.png)
...
![](https://s2.loli.net/2025/10/16/VNCGSHrxLpvD2PX.png)

把 nest 服务停掉，然后重新 npm run start

![](https://s2.loli.net/2025/10/16/wF37pEnSMPxL4HZ.png)

3001 和 3002 端口各跑一个：

![](https://s2.loli.net/2025/10/16/TdblWQBqxcXCZGm.png)

浏览器访问下，都是正常的：

![](https://s2.loli.net/2025/10/16/ryUDx9Rk8fuIsHS.png)

![](https://s2.loli.net/2025/10/16/dIylNxugnSwiFK3.png)

控制台也打印了访问日志：

![](https://s2.loli.net/2025/10/16/ErSWv1q4BwHNlaf.png)

问题来了，现在有一个 nginx 服务器，两个 nest 服务器了，nginx 该如何应对呢？

![](https://s2.loli.net/2025/10/16/3z5IcyfaYuoxZij.png)

nginx 的解决方式就是负载均衡，把请求按照一定的规则分到不同的服务器。

改下 nginx 配置文件：

![](https://s2.loli.net/2025/10/16/68eAgKabLfSwJFo.png)
...
![](https://s2.loli.net/2025/10/16/DPbVdqjaTsUh7NB.png)
...
![](https://s2.loli.net/2025/10/16/5wTSUk9VviNfelo.png)
...
![](https://s2.loli.net/2025/10/16/YrozNSpu1tsC4WX.png)

然后我访问了 8 次 http://localhost:81/api

看打印的日志来看，差不多就是 2:1 的轮询几率。

![](https://s2.loli.net/2025/10/16/C5zshcwbEo9xKG3.png)

这就是带权重的轮询。

我们再试下 ip_hash 的方式；

![](https://s2.loli.net/2025/10/16/NsvfG35PmbkA7up.png)
...
![](https://s2.loli.net/2025/10/16/xAZCdeREm7198Th.png)
