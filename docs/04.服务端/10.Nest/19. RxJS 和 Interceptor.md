...
![](https://s2.loli.net/2025/03/24/yoCDIi6unXqsgtj.png)

这里 node 能直接解析 esm 需要在 package.json 里设置 type 为 module：

![](https://s2.loli.net/2025/03/24/qcR3BSnwgAeuPZd.png)
...
![](https://s2.loli.net/2025/03/24/kxeONlRzaHs869V.png)
...
import { Observable, tap } from '0rxjs';
...
![](https://s2.loli.net/2025/03/24/GfxdRWUFM8tygzq.png)

然后浏览器访问 <http://localhost:3000>

![](https://s2.loli.net/2025/03/24/xWTPkdErGA52enJ.png)

就会看到打印的耗时数据：

![](https://s2.loli.net/2025/03/24/A5xadHDYvVp6jIC.png)

或者全局启用这个 interceptor：

![](https://s2.loli.net/2025/03/24/fFNpT6Wr2mHP8ve.png)

路由级别和全局级别的 interceptor 还是有区别的，路由级别的可以注入依赖，而全局的不行：

![](https://s2.loli.net/2025/03/24/MPQSmEAqvGgTzxW.png)

![](https://s2.loli.net/2025/03/24/z1Y4fWGLoFEDS9w.png)
...
![](https://s2.loli.net/2025/03/24/kwmratNJFGpuTAo.png)

跑下试试：

![](https://s2.loli.net/2025/03/24/BiAGYf3M1Je2Wzx.png)
...
![](https://s2.loli.net/2025/03/25/SAEZeru8yUoJ1nw.png)

浏览器访问这个接口，会打印日志：

![](https://s2.loli.net/2025/03/25/4wOpy5KktGocgBd.png)

![](https://s2.loli.net/2025/03/25/S8COcKMRenL61iD.png)
...
![](https://s2.loli.net/2025/03/25/CpbhORPA2BakSKF.png)

浏览器访问下，可以看到返回 500 的错误：

![](https://s2.loli.net/2025/03/25/tNzi6FRYbrBMAkC.png)

打印了两次错误：

![](https://s2.loli.net/2025/03/25/2jCkwgLxyv4Nond.png)
...
![](https://s2.loli.net/2025/03/25/9dECqt8xFAzYLUK.png)

![](https://s2.loli.net/2025/03/25/tRW6ycrg81LIUod.png)
...
![](https://s2.loli.net/2025/03/25/bVP7HrdycDE2NMF.png)

浏览器访问，3s 后返回 408 响应：

![](https://s2.loli.net/2025/03/25/KsVb1HG7dglrjNL.png)

就是在这里处理的：

![](https://s2.loli.net/2025/03/25/s8KTlMHRvngB16E.png)

不信可以抛一个其他的 exception 试一下：

![](https://s2.loli.net/2025/03/25/b5xmoyOcn84WV7X.png)

![](https://s2.loli.net/2025/03/25/wpzMlc1WTYXSRL3.png)

最后，再来看下全局的 interceptor：

![](https://s2.loli.net/2025/03/25/xtOCsqohWez8mR3.png)
...
![](https://s2.loli.net/2025/03/25/xqrlJfhOKPSQgT7.png)

在这个 interceptor 里我们注入了 appService：

![](https://s2.loli.net/2025/03/25/ofwlmGJPL8tZhMV.png)

添加一个路由：

![](https://s2.loli.net/2025/03/25/E4NLhX9R2A6nbBW.png)

访问下：

![](https://s2.loli.net/2025/03/25/J9mtYsxzCrNH14I.png)

可以看到全局 interceptor 生效了，而且这个 hello world 就是注入的 appService 返回的：

![](https://s2.loli.net/2025/03/25/z2CJOIxZt8wMd6Q.png)
