...
![](https://s2.loli.net/2025/05/30/vhHEg9OZdi8MwAb.png)
...
![](https://s2.loli.net/2025/05/30/Ax2rfjaCOgTl7qB.png)

然后通过一种叫做 UnionFS 的机制把这些层合并起来，变成一个文件系统：

![](https://s2.loli.net/2025/05/30/VvTN6elMK7g2RXL.png)

这样如果有多个容器内做了文件修改，只要创建不同的层即可，底层的基础镜像是一样的。

我们写的这个 Dockerfile，每一行指令都会生成一层镜像：

![](https://s2.loli.net/2025/05/30/l3Vdsg1m5JiqwXO.png)

点开 docker 镜像的详情可以看到：

![](https://s2.loli.net/2025/05/30/xnwJtSmo9YBXLis.png)
...
![](https://s2.loli.net/2025/05/30/xoqAKWNCbD4ITyH.png)

但是很多都是它继承的 node 镜像里的，可以看到每一层用了多少存储空间：

![](https://s2.loli.net/2025/05/30/YpAuoGSeCW7xOPT.gif)

我本地两个 nest 镜像，它们都继承了 node 镜像，这两个合起来有 2g 的存储空间么？

没有，因为下面的镜像层是公用的：

![](https://s2.loli.net/2025/05/30/f2ClbvY8M63t7xs.png)
...
![](https://s2.loli.net/2025/05/30/wWlRhTNIg7rKSsO.png)
...
![](https://s2.loli.net/2025/05/30/A4ihNpOcVvDbRnw.png)
...
![](https://s2.loli.net/2025/05/30/761z9XURojEbw2V.png)
