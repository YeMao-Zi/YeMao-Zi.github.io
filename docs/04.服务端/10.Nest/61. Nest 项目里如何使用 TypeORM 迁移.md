...
permalink: /pages/nestsytypeormqy/
categories:
  - 服务端
  - 《Node》笔记
  - Nest
...
![](https://s2.loli.net/2025/07/28/JF8WqLRtvcgCHl3.png)
...
![](https://s2.loli.net/2025/07/28/U1qTzVj5ipg2HMh.png)
...
![](https://s2.loli.net/2025/07/28/LWEBD8zcT1hvQnM.png)
...
![](https://s2.loli.net/2025/07/28/CbrsTXxWQVD1gkl.png)

然后在 mysql workbench 创建这个 database：

![](https://s2.loli.net/2025/07/28/smUeAzOikZtRTrb.png)

![](https://s2.loli.net/2025/07/28/ZuVRUoDplPjewa8.png)
...
![](https://s2.loli.net/2025/07/28/qm9QlA5i7ZUOEpn.png)

然后我们添加一些数据：

![](https://s2.loli.net/2025/07/28/pFNE5Y6be9n4WOG.png)
...
![](https://s2.loli.net/2025/07/28/9vgDFGcuUimqPOh.png)
...
![](https://s2.loli.net/2025/07/28/5SI3f1oOrizHnGM.png)

可以看到，数据插入成功了：

![](https://s2.loli.net/2025/07/28/IC4R8LhaSAvjVip.png)

![](https://s2.loli.net/2025/07/28/dNcmlSJC2Wv8Zut.png)

然后在查询接口里查一下：

![](https://s2.loli.net/2025/07/28/YCa2hpWlPSgjfTb.png)
...
![](https://s2.loli.net/2025/07/28/CXi4bYh3NOzGJfj.png)
...
![](https://s2.loli.net/2025/07/28/gJ6vyGzPLOuq9BX.png)

![](https://s2.loli.net/2025/07/28/SkDeFwz698J5lYc.png)

第一个选项是每个表一个 sql 文件，你也可以选择第二个选项，全部导出一个 sql 文件里：

![](https://s2.loli.net/2025/07/28/aozD934SmJwnfvG.png)

打开看下：

![](https://s2.loli.net/2025/07/28/GzKesoMm5TyaXdu.png)
...
![](https://s2.loli.net/2025/07/28/nS5aVYxJj2zAPRs.png)
...
![](https://s2.loli.net/2025/07/28/RzsnwAVuHGK6ohq.png)

它会对比 entity 和数据表的差异，生成迁移 sql：

![](https://s2.loli.net/2025/07/28/kgxTI4RrCPYUKMA.png)

### 跑下可以看到，生成的 migration 类里包含了 create table 的 sql。
...
![](https://s2.loli.net/2025/07/28/RXZKQSB6YdqDbUF.png)

可以看到，执行了两条 create table 语句。

在数据库里看下：

![](https://s2.loli.net/2025/07/28/gZoGQbqFn583Oiu.png)

migrations 表里记录了执行过的 migration，已经执行过的不会再执行。

article 表就是我们需要在生产环境创建的表：

![](https://s2.loli.net/2025/07/28/ouO2yxcm3iKdEwR.png)
...
![](https://s2.loli.net/2025/07/28/zLh3vuKd9tTsgna.png)
...
![](https://s2.loli.net/2025/07/28/pVIFOQAxe8Ydt2X.png)

在生成的迁移 class 里填入 insert into 的 sql 即可。

### 把刚才导出的那个 sql 里的 insert into 语句复制过来。

![](https://s2.loli.net/2025/07/28/t31nbLZ2P4XcsDg.png)

![](https://s2.loli.net/2025/07/28/3EOKxF8dgGb9uiS.png)
...
![](https://s2.loli.net/2025/07/28/zWCYwuMGj9oRl7N.png)
...
![](https://s2.loli.net/2025/07/28/DaJ1nsdegr5YwVo.png)

![](https://s2.loli.net/2025/07/28/9CXvKVYTeONyDHr.png)
...
![](https://s2.loli.net/2025/07/28/yGB1dFCzSH24Tpv.png)
...
![](https://s2.loli.net/2025/07/28/Ax4g5TsnSIrKbd7.png)

生成了 alter table 的 sql：

![](https://s2.loli.net/2025/07/28/B9jmAcbRahiUztv.png)
...
![](https://s2.loli.net/2025/07/28/QEInYlHXqDWJ9Th.png)

一条 alter table 的 sql，一条 insert 的 sql。

可以看到，article 表多了 tags 列，migrations 表也插入了一条执行记录：

![](https://s2.loli.net/2025/07/28/3bSKM9Yvna75ljG.png)

![](https://s2.loli.net/2025/07/28/aZJ12o8EFj9DPSk.png)
...
![](https://s2.loli.net/2025/07/28/H6lA1YkQKDO9Mso.png)

用到 ConfigModule，这个是下节的内容，这里就不展开了：

![](https://s2.loli.net/2025/07/28/OlTzBjdNy5wrxo8.png)
...
![](https://s2.loli.net/2025/07/28/4RrjYPo1TteWUfp.png)
