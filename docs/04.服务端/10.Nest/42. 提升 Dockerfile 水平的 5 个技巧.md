...
![](https://s2.loli.net/2025/05/30/j7qURbSr92Hsghe.png)

但是，这个容器和宿主机还是有关联的，比如可以把宿主机的端口映射到容器内的端口、宿主机某个目录挂载到容器内的目录。

![](https://s2.loli.net/2025/05/30/P1AESVbO8uLG2IY.png)
...
![](https://s2.loli.net/2025/05/30/ODGkJ9jc7Rtl1To.png)
...
![](https://s2.loli.net/2025/05/30/ebYkmjhOJFpD7Rd.png)
...
![](https://s2.loli.net/2025/05/30/S3GirsCP89NLqZY.png)

这时候访问 http://localhost:3000 可以看到 hello world，说明服务跑成功了:

![](https://s2.loli.net/2025/05/30/qAZv2umzdLNDE5C.png)
...
![](https://s2.loli.net/2025/05/30/QMw58mcLF6oIdsV.png)

然后在 docker desktop 的 images 里就可以看到这个镜像了：

![](https://s2.loli.net/2025/05/30/Uh7nHfvjAMz2obF.png)
...
![](https://s2.loli.net/2025/05/30/T5d3NJnjS27LGcY.png)

然后就可以看到容器部分有了这个容器了：

![](https://s2.loli.net/2025/05/30/SJH3Zm8XugPybzF.png)

浏览器访问 http://localhost:2333 就可以访问容器内跑的这个服务：

![](https://s2.loli.net/2025/05/30/IKgSBdmuLQEO3xn.png)

这就是 Dockerfile 构建成镜像，然后通过容器跑起来的流程。

![](https://s2.loli.net/2025/05/30/5l67uvqk9nzGphC.png)
...
![](https://s2.loli.net/2025/05/30/if8WTvojscNKdw6.png)
...
![](https://s2.loli.net/2025/05/30/PGcHSbKTn6XfvUr.png)

alpine 是高山植物，就是很少的资源就能存活的意思。

我们改下 dockerfile，使用 alpine 的镜像：

![](https://s2.loli.net/2025/05/30/I9PKFXRigAk7HUm.png)
...
![](https://s2.loli.net/2025/05/30/TWPBqVDGejf1h2N.png)

这次的 tag 为 second。

然后在 docker desktop 里看下：

![](https://s2.loli.net/2025/05/30/hk2HlWVzo4Oraqp.png)

好家伙，足足小了 900M。

我们点开看看：

![](https://s2.loli.net/2025/05/30/BoQpL8MxTwPbeaG.png)
...
![](https://s2.loli.net/2025/05/30/hB2qbRCXrml34gJ.png)

docker desktop 可以看到这个跑起来的容器：

![](https://s2.loli.net/2025/05/30/FGtlozyUipdIVr4.png)

浏览器访问下，依然是正常的：

![](https://s2.loli.net/2025/05/30/sfJH5wrvu2lAziC.png)
...
![](https://s2.loli.net/2025/05/30/hViHOtyoCk2pcEP.png)
...
![](https://s2.loli.net/2025/05/30/DcBaYm5iIARdzxs.png)

现在我们改下 README.md：

![](https://s2.loli.net/2025/05/30/hHGrf9baTRgX3iN.png)

然后重新跑 build：

![](https://s2.loli.net/2025/05/30/CrHs9E65aMPZ4KW.png)

现在花了 25s，其实是没有重新 npm install 的。

然后改下 package.json：

![](https://s2.loli.net/2025/05/30/Cf8qzm2vbwgOJ93.png)

再跑 docker build

![](https://s2.loli.net/2025/05/30/jV5eGvruqSKntBH.png)

时间明显多了很多，过程中你可以看到在 npm install 那层停留了很长时间。

这就是为什么要这样写：

![](https://s2.loli.net/2025/05/30/j9pN6sFndk4mto3.png)
...
![](https://s2.loli.net/2025/05/30/rNlqnfOVLcIweJo.png)

然后 desktop 里看下构建出来的镜像：

![](https://s2.loli.net/2025/05/30/ECIHnt6cubZmsTW.png)

镜像体积比没有用多阶段构建的时候小了 250 M。

然后跑起来试试看：

![](https://s2.loli.net/2025/05/30/VfjLpXMqBzk2not.png)

这次映射 2335 端口到容器内的 3000 端口。

依然能正常访问：

![](https://s2.loli.net/2025/05/30/W7jXD2ZbVGSYRO4.png)
...
![](https://s2.loli.net/2025/05/30/5JvTuMl1aKOiWqY.png)
...
![](https://s2.loli.net/2025/05/30/lO7x4bKjgNptZVH.png)

点击查看镜像详情，可以看到 ARG 已经被替换为具体的值了：

![](https://s2.loli.net/2025/05/30/rG7jifpPX3q64Cc.png)

![](https://s2.loli.net/2025/05/30/H7Nzr4A5CWbTVQY.png)
...
![](https://s2.loli.net/2025/05/30/eG1Lif2FIqKZvCD.png)
...
![](https://s2.loli.net/2025/05/30/EhzvPItw1mqZf2B.png)

其实还可以写成 ENTRYPOINT：

![](https://s2.loli.net/2025/05/30/GBpEbU5a9AOWDiN.png)
...
![](https://s2.loli.net/2025/05/30/7wcFWeqiHhBtSUA.png)
...
![](https://s2.loli.net/2025/05/30/qaZcEFPwnQrXMN6.png)

没有指定 --name 时，会生成一个随机容器名。

就是这种：

![](https://s2.loli.net/2025/05/30/W43BbgMv5CozxZK.png)
...
![](https://s2.loli.net/2025/05/30/5DsR6E3PuyYgVtl.png)
docker run:
...
![](https://s2.loli.net/2025/05/30/iyAmjJ7NgUcDRPp.png)
...
![](https://s2.loli.net/2025/05/30/rPXnRAd9zby56oT.png)
...
![](https://s2.loli.net/2025/05/30/1ZC7n8sUueMpJIE.png)
...
![](https://s2.loli.net/2025/05/30/d7sKVgSuH3PXFtZ.png)
...
![](https://s2.loli.net/2025/05/30/2pg8zINeSJA6BGh.png)
...
![](https://s2.loli.net/2025/05/30/SwTlQspdKCGfazM.png)
...
![](https://s2.loli.net/2025/05/30/8mL6I1qjtBuygar.png)

可以看到，ADD 把 tar.gz 给解压然后复制到容器内了。

![](https://s2.loli.net/2025/05/30/mG15hSU2vR86Mfd.png)

而 COPY 没有解压，它把文件整个复制过去了：

![](https://s2.loli.net/2025/05/30/AngQUMdesTEHRxz.png)

![](https://s2.loli.net/2025/05/30/la5VSBJ3iNQ4fRE.png)
...
![](https://s2.loli.net/2025/05/30/tm2OkAMKQIcfSp5.png)
