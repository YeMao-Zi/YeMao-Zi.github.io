...
![image-20250317105844478](C:\Users\92924\AppData\Roaming\Typora\typora-user-images\image-20250317105844478.png)

但如果要从导入的 Module 中自动获取改模块中的注入值，就必须 exports 导出注入，这种方式叫做模块的重导出。

![image-20250317110306453](https://s2.loli.net/2025/03/17/4csjkVdM3WePNaJ.png)
