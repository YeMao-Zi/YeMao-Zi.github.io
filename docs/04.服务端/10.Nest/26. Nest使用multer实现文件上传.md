...
```
![](https://s2.loli.net/2025/04/01/K8MstiYVcxbewf1.png)
...
![](https://s2.loli.net/2025/04/01/KUjVboAn1W472Cp.gif)
...
![](https://s2.loli.net/2025/04/03/yu7doUitgHAQN2p.png)
...
![](https://s2.loli.net/2025/04/03/SIog1CRMYaTbEhn.png)

![](https://s2.loli.net/2025/04/03/K2yFQtE6C3qUHTo.png)
...
![](https://s2.loli.net/2025/04/03/h8jlgLm2YrpRxAn.gif)

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](https://s2.loli.net/2025/04/03/TgCQSA1RGBxqdDn.png)
...
![](https://s2.loli.net/2025/04/03/lVAPymSoairK4wh.png)
...
![](https://s2.loli.net/2025/04/03/BUlwiYQAJIFz58v.gif)

后端收到了上传的 aaa、bbb 的文件：

![](https://s2.loli.net/2025/04/03/C3zirN7oMQ5ptxv.png)
...
![](https://s2.loli.net/2025/04/03/IUvLqxdnF76SVHy.png)
...
![](https://s2.loli.net/2025/04/03/EJUbT7xhP6wdNig.png)

![](https://s2.loli.net/2025/04/03/xijPNv13LBFUCt4.png)
...
![](https://s2.loli.net/2025/04/03/3LbMPHjZ7lriN6n.png)

在 FileInterceptor 里也是一样：

![](https://s2.loli.net/2025/04/03/cBZNEOr1C6oiaGH.png)

在 multer 里我们是通过 array 方法来处理多个 file 的字段：

![](https://s2.loli.net/2025/04/03/wSfcqXp2tzFOsaj.png)

在 FilesInterceptor 里也一样：

![](https://s2.loli.net/2025/04/03/LA4yYbtHgeVuSnG.png)

另外两个装饰器也是同理：

![](https://s2.loli.net/2025/04/03/gEOu3QATGn2c5F1.png)

![](https://s2.loli.net/2025/04/03/V8TiQvxZeIYpMwW.png)

而 UploadedFile、UploadedFiles 这些装饰器，只是从 request 中取出处理完的 file、files 等属性作为参数传入 handler：

![](https://s2.loli.net/2025/04/03/CfNcl2UgJGWa3VQ.png)

了解了这些装饰器的原理之后，回头再来看这些文件上传用的装饰器，是不是就很清晰了呢：

![](https://s2.loli.net/2025/04/03/9TgGmYC8FLzl534.png)
...
![](https://s2.loli.net/2025/04/03/NbXVUmvQZ2cgosO.png)

然后访问下：

![](https://s2.loli.net/2025/04/03/hWZDpy4dtvXY3qI.png)
...
![](https://s2.loli.net/2025/04/03/L1V7wHpiXGzCcAy.png)
...
![](https://s2.loli.net/2025/04/03/3Gw5r2OV1dTY6Qa.png)

![](https://s2.loli.net/2025/04/03/LbD1ci7P6f2FMgt.png)
...
![](https://s2.loli.net/2025/04/03/irgKJ4mjfueCp9z.png)

在浏览器上传个文件：

![](https://s2.loli.net/2025/04/03/coBTJS1eAu3VLwZ.png)
