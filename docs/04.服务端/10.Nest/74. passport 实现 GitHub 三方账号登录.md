...
![](https://s2.loli.net/2025/09/08/8AX4afPbFL96cWM.png)
...
![](https://s2.loli.net/2025/09/08/k82hBRDyv9VCnoq.png)
...
![](https://s2.loli.net/2025/09/08/kByQW9C82cYSxqz.png)

![](https://s2.loli.net/2025/09/08/ZQsCVUGeojcYu9m.png)

![](https://s2.loli.net/2025/09/08/OR1zAS8khDYfqLH.png)

点击 settings > developer settings > new OAuth App

填入信息后，点击 register application：

![](https://s2.loli.net/2025/09/08/hCriuYLdPwJ84v2.png)

现在 client id 有了，点击生成 secret

![](https://s2.loli.net/2025/09/08/JhrUGDdTxFosXbW.png)

提示你了，这里的 secret 只能看见这一次，复制保存下来（当然，丢了也没啥，可以再次生成）：

![](https://s2.loli.net/2025/09/08/PApKMaRYJ6851Dz.png)
...
![](https://s2.loli.net/2025/09/08/BT3QukqzjO1omc7.png)
...
nest g module auth
```
![](https://s2.loli.net/2025/09/08/SJIzVY3ZXsUvMml.png)
...
![](https://s2.loli.net/2025/09/08/ReKGSdrHDmJQxkq.png)

然后点击 authorize，会回调 callback 接口：

![](https://s2.loli.net/2025/09/08/WRHQMGk3Xs5BZu1.png)
...
![](https://s2.loli.net/2025/09/08/CIkGAKgPNvlBdxE.gif)
