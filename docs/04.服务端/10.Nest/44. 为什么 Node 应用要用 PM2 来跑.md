...
![](https://s2.loli.net/2025/05/30/wE8FaD3vY7B4Gdz.png)
...
![](https://s2.loli.net/2025/05/30/B95YMAwJONWa8Re.png)
...
![i](https://s2.loli.net/2025/05/30/5CYUsapvEcHVdXl.png)
...
![](https://s2.loli.net/2025/05/30/KU3xXpiYyNC1DZs.png)

比如 main-out.log 里保存了 main 进程的正常日志，而 main-error.log 里保存了它的报错日志：

![](https://s2.loli.net/2025/05/30/FZjLSfeazNpJslu.png)

我们再跑一个进程试试：

![](https://s2.loli.net/2025/05/30/AFYWVqe6I5QHRBc.png)

现在有两个进程了，pm2 logs 可以看到这两个进程的日志：

![](https://s2.loli.net/2025/05/30/ucVfU8Nbg9XZYK3.png)
...
![](https://s2.loli.net/2025/05/30/oNdkVRIAn7i3qrK.png)
...
![](https://s2.loli.net/2025/05/30/AhuS3UFI5dRp1Jm.png)

我们指定 1k 内存就重启：

    pm2 start xxx --max-memory-restart 1K

![](https://s2.loli.net/2025/05/30/hFzWZop3gJGldUk.png)

然后在 nest 代码里用超过 1k 的内存：

![](https://s2.loli.net/2025/05/30/XJFQWCtEVro7TPw.png)

先把之前的日志清空，使用 pm2 flush 或者 pm2 flush 进程名|id

![](https://s2.loli.net/2025/05/30/gMBHAm5KrEyWSaD.png)

确实清空了：

![](https://s2.loli.net/2025/05/30/Njk17ytXCZAhKQI.png)

访问下这个 controller：

![](https://s2.loli.net/2025/05/30/KSjAQ6irpGxzqmW.png)

查看 main 进程的前 100 行日志：

    pm2 logs main --lines 100

![](https://s2.loli.net/2025/05/30/GvVSmQRxlwXLYpI.png)
...
![](https://s2.loli.net/2025/05/30/6m83jPKigtZOxHh.png)
...
![](https://s2.loli.net/2025/05/30/YtS24wis9L7ZrnC.png)
...
![](https://s2.loli.net/2025/05/30/iwqB8lyRtAEIJYZ.png)
...
![](https://s2.loli.net/2025/05/30/jnZ4xRpgwOiT9QF.gif)
...
![](https://s2.loli.net/2025/05/30/kb8xmPiCSvEz4Zq.png)

apps 部分就是配置应用的，scripts 就是应用的启动路径：

![](https://s2.loli.net/2025/05/30/BMClpQkSND8Fwjo.png)

它可以指定的配置非常多，基本就是命令行有啥选项，这里就有啥属性：

![](https://s2.loli.net/2025/05/30/Yq9zRwHebiTapWy.png)
...
![](https://s2.loli.net/2025/05/30/8mUwcCHyEtJ6joK.png)

然后在本地执行 pm2 link xxx xxx，把本地的 pm2 和那个网站关联起来：

![](https://s2.loli.net/2025/05/30/8gtZPyG2jIYKi5N.png)

再执行 pm2 plus 就会打开 bucket 对应的网页：

![](https://s2.loli.net/2025/05/30/MinyJABTfjXs5Cb.png)

可以在线监控你的应用：

![](https://s2.loli.net/2025/05/30/l39iPkwujtnq7QF.png)

下面这些 plus 的功能都是收费的：

![](https://s2.loli.net/2025/05/30/lhEGbVvnDeLuaKk.png)
...
![](https://s2.loli.net/2025/05/30/cOEruzRHiTGQoCM.png)
...
![](https://s2.loli.net/2025/05/30/vGyE3M6fPNiZzAV.png)
...
![](https://s2.loli.net/2025/05/30/64vJRzoENaO1mSd.png)

把它跑起来：

![](https://s2.loli.net/2025/05/30/2ST8Mce1Y9us5gE.png)

![](https://s2.loli.net/2025/05/30/GeOnBcxIRpXrowa.png)

![](https://s2.loli.net/2025/05/30/AM492Vua8zhLiZy.png)

这个就是 pm2 打印的日志。

你可以在 terminal 使用 pm2 的命令：

![](https://s2.loli.net/2025/05/30/q9X5cYsPoNtTymK.png)
