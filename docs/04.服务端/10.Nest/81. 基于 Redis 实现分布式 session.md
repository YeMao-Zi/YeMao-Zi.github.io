...
![](https://s2.loli.net/2025/10/22/GLMsTkvjlZqamD7.png)
...
```
![](https://s2.loli.net/2025/10/22/lfFKczTErUsmgAH.png)
...
![](https://s2.loli.net/2025/10/22/VeZFn3O2givjbNl.webp)
...
```
![](https://s2.loli.net/2025/10/22/e7qzbgXaJrSujxQ.png)
...
![](https://s2.loli.net/2025/10/22/ypHYFeztn4dJVv6.png)
...
![](https://s2.loli.net/2025/10/22/OaenFKTQgG2sUPV.png)
...
![](https://s2.loli.net/2025/10/22/vJxbhoXTlM8ewEs.png)

现在 getSession 返回的是 Record<string, any> 也就是对象类型，但并不知道有啥具体的属性。

![](https://s2.loli.net/2025/10/22/WE6X31749DuArJQ.png)
...
![](https://s2.loli.net/2025/10/22/bXBU9EMwlY4FHeu.png)

传入类型参数之后，返回的就是该类型了：

![](https://s2.loli.net/2025/10/22/SWDC2MrBXP64Ogm.png)
...
![](https://s2.loli.net/2025/10/22/mD1IZ874XVQqWwJ.gif)

我们自己实现的 session 就生效了：

![](https://s2.loli.net/2025/10/22/KfBIA2UXeurDwRg.png)

在 Redis Insight 里可以看到 session 的值

![](https://s2.loli.net/2025/10/22/kDVpa6heCNs3JG2.png)

而且这个 session 是支持分布式的。


![](https://s2.loli.net/2025/10/22/TKmSgHVGzl6twP8.png)
