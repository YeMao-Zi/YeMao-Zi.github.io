...
```
![](https://s2.loli.net/2025/09/10/VSo1O2tERXMdIrY.png)
...
![](https://s2.loli.net/2025/09/10/1LUdSAwBfVqzZK3.png)
...
很明显，最关键的也是要获取 client id 和 client secret。

打开 google cloud 的控制台页面https://console.cloud.google.com/welcome

点击左上角的按钮，然后点击 new project：

![](https://s2.loli.net/2025/09/10/3C5bV1PfZrsupnw.gif)

填入项目名后点击 create：

![](https://s2.loli.net/2025/09/10/EDWBi7TLRzlmx1F.png)

点击左上角的按钮切换到你刚刚创建的 project：

![](https://s2.loli.net/2025/09/10/5NW42jSfMLhA3ck.png)

进入 api & service 页面：

![](https://s2.loli.net/2025/09/10/Exp1dbegLNlJrqV.png)

点击 OAuth consent screen，然后勾选 external，点击 create：

![](https://s2.loli.net/2025/09/10/bJTnezfKP73OMYR.png)

输入三个必填信息：

![](https://s2.loli.net/2025/09/10/ONlciyxEhrf9YVZ.png)

![](https://s2.loli.net/2025/09/10/wyRgaXs9C2f7q46.png)

点击 save and continue。

然后点击 Credentials 创建凭证：

![](https://s2.loli.net/2025/09/10/THO4Ij26QWofr3P.png)

输入应用类型、name、填入授权的域名、回调的 url，点击 create：

![](https://s2.loli.net/2025/09/10/nGstjEFQ8uMxrOq.png)

这样 client id 和 client secret 就生成好了：

![](https://s2.loli.net/2025/09/10/WKka4ztnIcZsedh.png)
...
![](https://s2.loli.net/2025/09/10/YOCagyseDZpfVI5.png)
...
![](https://s2.loli.net/2025/09/10/Np71htQAuVqWoxH.png)
...
![](https://s2.loli.net/2025/09/10/ObjVdohAeLYqDnk.png)
测试下：
![](https://s2.loli.net/2025/09/10/rZYh9kTOzC1nGiU.gif)

可以看到，google 的用户信息拿到了：

![](https://s2.loli.net/2025/09/10/Z19KWAbosYM2gH6.png)

这里没有 github 返回的那种有 id，但这里返回了 email，同样可以唯一标识用户。

你可以试下 [medium.com](https://medium.com/) 的三方登录：

![](https://s2.loli.net/2025/09/10/3OBYRx4fFt1Wmwk.gif)
...
![](https://s2.loli.net/2025/09/10/N1OqSxuHTFIvP7C.gif)
...
![](https://s2.loli.net/2025/09/10/HPUdTjO4BR7faiF.png)
...
![](https://s2.loli.net/2025/09/10/PYv495Tr7DXoVzU.png)

![](https://s2.loli.net/2025/09/10/qfUBIzulEmynWSj.png)
...
![](https://s2.loli.net/2025/09/10/SOJQkAoI43CBUEW.png)
...
![](https://s2.loli.net/2025/09/10/GhxrQy3UPF5Yjle.png)

这部分和我们单独跑 typeorm 没啥区别：

![](https://s2.loli.net/2025/09/10/aNkQhbrpKVu84og.png)

然后是增删改查，我们可以注入 EntityManager：

![](https://s2.loli.net/2025/09/10/y8oHUzqGvsmwYIQ.png)

自动创建了对应的表。

在 mysql workbench 里也可以看到：

![](https://s2.loli.net/2025/09/10/ZLKc2p3WV1h9Por.png)
...
![](https://s2.loli.net/2025/09/10/3dIiHgANYKV6EjB.gif)

因为前面登录过 google 账号并授权了，短时间内不需要再次授权，所以这里直接触发了注册并登录了。

![](https://s2.loli.net/2025/09/10/kQ4u5tl79aOYnGs.png)

![](https://s2.loli.net/2025/09/10/ohIlBmgSLxijY9U.png)

当你用这个 google 账号登录，就会直接登录，不需要再注册了。

## 当然，网站登录后一般都会重定向到首页，那这时候怎么返回 jwt 的token 呢？

![](https://s2.loli.net/2025/09/10/csXtUdiARQ6PEIw.gif)

看下 https://hub.docker.com 怎么做的：

![](https://s2.loli.net/2025/09/10/FnPloKOqsWrEhTN.png)
...
![](https://s2.loli.net/2025/09/10/KxW61o2U8AQB7Sz.png)
