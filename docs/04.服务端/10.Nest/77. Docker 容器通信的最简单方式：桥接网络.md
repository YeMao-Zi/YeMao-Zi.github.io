...
![](https://s2.loli.net/2025/10/15/BWpoumbEqCNDvsc.png)
...
![](https://s2.loli.net/2025/10/15/i6ZpszEYCng91r4.png)
...
![](https://s2.loli.net/2025/10/15/kZ2U1HMIzS9Nnvm.png)
...
![image.png](https://s2.loli.net/2025/10/15/QZ4YkIO6x5oKrgq.png)
...
![](https://s2.loli.net/2025/10/15/g5QWZjhVvHNX28T.png)

### 然后 nest 的部分我们要改下代码：

修改 AppModule 的代码，改成用容器名来访问：

![](https://s2.loli.net/2025/10/15/QFIBGoVOkZJyWdN.png)
...
docker build -t mmm .
```
![](https://s2.loli.net/2025/10/15/9eBzI7gxZQdniJP.png)
...
![](https://s2.loli.net/2025/10/15/M13Evx89hokXLda.png)
...
![](https://s2.loli.net/2025/10/15/na2U8NxAM1dRfgv.png)
...
![](https://s2.loli.net/2025/10/15/4ePuVhEiHaQr9dS.png)
...
![](https://s2.loli.net/2025/10/15/YmtR4jyqK1W8CE3.png)

原理前面讲过，就是 Namespace。

本来是 3 个独立的 Network Namespace：

![](https://s2.loli.net/2025/10/15/aNx2Jmw5uon6qOR.png)

桥接之后就这样了：

![](https://s2.loli.net/2025/10/15/DWy8FrbXBMHYQoT.png)
...
![](https://s2.loli.net/2025/10/15/5kFZioIGnUXBqSN.png)
...
![](https://s2.loli.net/2025/10/15/GfbeUdi3lu4HQt7.png)
...
![](https://s2.loli.net/2025/10/15/uv4wiVJsO7aAmMK.png)
...
![](https://s2.loli.net/2025/10/15/TsKNyH6mc2PzeW7.png)

可以看到，会先 build dockerfile 产生镜像，然后把 3 个镜像跑起来。

![](https://s2.loli.net/2025/10/15/7m2ae1xBgHSn6lT.png)
...
![](https://s2.loli.net/2025/10/15/LBqQEluj7oIkYnw.png)

也拿到了 redis 的 key，说明 redis 服务跑成功了：

![](https://s2.loli.net/2025/10/15/WlSrOIyvBdwHzFY.png)
...
docker-compose down --rmi all
```
![](https://s2.loli.net/2025/10/15/ihXlCNEJdfOAQgY.png)

把 networks 部分注释掉，重新跑：

![](https://s2.loli.net/2025/10/15/JQZzyHboPBslAIX.png)

你会发现它创建了一个默认的 network：

![](https://s2.loli.net/2025/10/15/KN2Yj3wh7Hzl5sF.png)

mysql 和 redis 的访问都是正常的：

![](https://s2.loli.net/2025/10/15/YulOVFSARCL5s3Q.png)
