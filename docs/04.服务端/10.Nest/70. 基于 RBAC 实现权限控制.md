...
![](https://s2.loli.net/2025/08/28/FkgBsGVdbXCJ27W.png)

直接给用户分配权限。

而 RBAC 是这样的：

![](https://s2.loli.net/2025/08/28/6krqeWNlvdIgC1t.png)
...
![](https://s2.loli.net/2025/08/28/fT1DdBzuoVRF6cE.png)

可以看到创建出的 database：

![](https://s2.loli.net/2025/08/28/LBiH6Fbj2C5NzKq.png)
...
![](https://s2.loli.net/2025/08/28/hzfJwRKpQDbmIoN.png)
...
![](https://s2.loli.net/2025/08/28/Swa3tTxzvFli481.png)

## 添加 User、Role、Permission 的 Entity：

![](https://s2.loli.net/2025/08/28/Z9mB2YiPz7wEGNj.png)
...
![](https://s2.loli.net/2025/08/28/9ipoAkDl3V2fPO5.png)
...
![](https://s2.loli.net/2025/08/28/nK5rk7YvAjDdas2.png)
...
![](https://s2.loli.net/2025/08/28/To3PtxEiKJ9AIp8.png)

![](https://s2.loli.net/2025/09/01/Qz8iBcvaIelKfxX.png)

![](https://s2.loli.net/2025/09/01/AJQxwRE8N5yP4ko.png)

![](https://s2.loli.net/2025/09/01/yELCg485Kbhcsik.png)

![](https://s2.loli.net/2025/09/01/Zvx7iTA5JtwR12q.png)

还有外键：

![](https://s2.loli.net/2025/09/01/SxtuRkOEoJfYwQa.png)

![](https://s2.loli.net/2025/09/01/KBNhFxtofQcyAUl.png)
...
![](https://s2.loli.net/2025/09/01/uL3kqwmsVbEOWJK.png)
...
![](https://s2.loli.net/2025/09/01/ZRHl6Mn4IGYhKeE.png)

服务端控制台打印了一堆 sql：

![](https://s2.loli.net/2025/09/01/AsPkMLE163K5Bmw.png)
...
![](https://s2.loli.net/2025/09/01/nVL6oB7dm32O5MT.png)

role 表：

![](https://s2.loli.net/2025/09/01/uyX96ziO2VFbQm1.png)

user 表：

![](https://s2.loli.net/2025/09/01/4kTiCwjJncvrKtI.png)

role_permission_relation 中间表：

![](https://s2.loli.net/2025/09/01/ZXwe8fqNBhnb7kx.png)

user_role_relation 中间表：

![](https://s2.loli.net/2025/09/01/Ls9Yjpuw8vcNWBT.png)
...
![](https://s2.loli.net/2025/09/01/GKIn5amSLCN1R46.png)

然后在 postman 里测试下：

ValidationPipe 不通过的时候，会返回错误信息：

![](https://s2.loli.net/2025/09/01/HwTe3uDYmN7EgnZ.png)

ValidationPipe 通过之后，就会执行 handler 里的方法：

![](https://s2.loli.net/2025/09/01/d5q2ie6YJ9xAOwt.png)

![](https://s2.loli.net/2025/09/01/rJPuo3iI4GeH2gQ.png)
...
![](https://s2.loli.net/2025/09/01/pkmNqnQlXPGrDCI.png)

![](https://s2.loli.net/2025/09/01/to2aRyNuHqjT6x1.png)
...
![](https://s2.loli.net/2025/09/01/N4tk7qibWJnRoF6.png)
...
![](https://s2.loli.net/2025/09/01/nOWhRXN17KJr3Qp.png)
...
![](https://s2.loli.net/2025/09/01/hGzZNuBPJAnSlRE.png)

![](https://s2.loli.net/2025/09/01/6sLyBCu5grZDGXE.png)

现在这些接口可以直接访问：

![](https://s2.loli.net/2025/09/01/sfuy4iQtc5TObYr.png)

![](https://s2.loli.net/2025/09/01/QSLbyRNwDICEj6a.png)
...
![](https://s2.loli.net/2025/09/01/LyRFl5eXp7dhCk2.png)

但这时候会报错 user 不在 Request 的类型上。

扩展下就好了：

![](https://s2.loli.net/2025/09/01/wMpfteQjEh7aYJo.png)
...
![](https://s2.loli.net/2025/09/01/Ie8QoZCjFmYRMLU.png)

### 这样太麻烦了，这次我们全局加守卫：

![](https://s2.loli.net/2025/09/01/JKTPjNCbMYh2dyz.png)
...
![](https://s2.loli.net/2025/09/01/D7XSehZVlixvyLK.png)

再访问下 aaa、bbb 接口：

![](https://s2.loli.net/2025/09/01/35diGyjFInVeKZO.png)

![](https://s2.loli.net/2025/09/01/3s78F6VJDIOTomv.png)

但这时候你访问 /user/login 接口也被拦截了：

![](https://s2.loli.net/2025/09/01/Hh6i3fAVE2sSYg5.png)
...
![](https://s2.loli.net/2025/09/01/BvfgNPiGYyFOSnM.png)

![](https://s2.loli.net/2025/09/01/AS3BG4NbgIMm7Xy.png)

我们支持在 controller 上添加声明，不需要每个 handler 都添加，这样方便很多。

### 然后需要改造下 LoginGuard，取出目标 handler 的 metadata 来判断是否需要登录：

![](https://s2.loli.net/2025/09/01/CEpfSmbeotIj3Ml.png)
...
![](https://s2.loli.net/2025/09/01/8qwxpUbOZvKzC2m.png)

因为没有 require-login 的 metadata：

![](https://s2.loli.net/2025/09/01/rhe2LKfMsiCjRl9.png)

而 aaa、bbb 是需要登录的：

![](https://s2.loli.net/2025/09/01/I1Sfbt2PBLxEh7V.png)

![](https://s2.loli.net/2025/09/01/bMKqwYIVOjFGtmp.png)

因为它们包含 require-login 的 metadata：

![](https://s2.loli.net/2025/09/01/6dQkBvjFaTEsrbP.png)

然后我们登录下，带上 token 访问试试：

![](https://s2.loli.net/2025/09/01/Nkmiqx8OJbu491T.png)

![](https://s2.loli.net/2025/09/01/unsaRL8wgeZ2E6p.png)
...
![](https://s2.loli.net/2025/09/01/VWNtJkiSEy9agU6.png)

PermissionGuard 里需要用到 UserService，所以在 UserModule 里导出下 UserService：

![](https://s2.loli.net/2025/09/01/fM3EYsRdD75QAkG.png)
...
![](https://s2.loli.net/2025/09/01/gYrvFRd3ukhXbjM.png)

可以看到打印了这个用户拥有的角色的所有 permission 信息：

![](https://s2.loli.net/2025/09/01/b1RMgNyXdwzUZkx.png)
...
![](https://s2.loli.net/2025/09/01/Fd6EDkrb9tPIRZT.png)

在 PermissionGuard 里取出来判断：

![](https://s2.loli.net/2025/09/01/8meVf9xtgPsUHdB.png)
...
![](https://s2.loli.net/2025/09/01/HCwTPhApqYxjRzS.png)

带上 token 访问：

![](https://s2.loli.net/2025/09/01/YfPV4BcHRTsheSd.png)
...
![](https://s2.loli.net/2025/09/02/w5rTSBm2Lals38q.png)
...
![](https://s2.loli.net/2025/09/01/A36NKDwak9QjBUI.png)

我们再登录下张三账号：

![](https://s2.loli.net/2025/09/02/uqcZjaz9D31s2UY.png)

用这个 token 去访问下 bbb 接口，就能正常访问了：

![](https://s2.loli.net/2025/09/02/tmGRjeo5kr6iQp1.png)

他是有这个权限的：

![](https://s2.loli.net/2025/09/02/CMetovL2j3XyGmW.png)
