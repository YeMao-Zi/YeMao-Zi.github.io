---
title: access_token和refresh_token实现无感登录
date: 2025-03-10 14:24:01
permalink: /pages/sxwgdlsx/
categories:
  - 服务端
  - 《Node》笔记
  - Nest
...
![](https://s2.loli.net/2025/09/02/EHq7SAsDYzGBo3I.png)

访问接口的时候带上 jwt，在 Guard 里取出来判断是否有效，有效的话才能继续访问：

![](https://s2.loli.net/2025/09/02/eUEVBMGsdr1pmza.png)
...
## 为了解决 token 失效这个问题，服务端一般会返回两个 token：access_token 和 refresh_token
...
![](https://s2.loli.net/2025/09/02/43edFt8m5BHaibx.png)

access_token 用来做登录鉴权：

![](https://s2.loli.net/2025/09/02/IsN3tK7DFoXVUT1.png)
...
![](https://s2.loli.net/2025/09/02/bQzDA7h8KpVneoa.png)
...
![](https://s2.loli.net/2025/09/02/a24LhIrpD1gnfYB.png)
...
![](https://s2.loli.net/2025/09/02/DhZpG9IOVUm6kYC.png)

![](https://s2.loli.net/2025/09/02/Oh6yjAWkRVUcvXg.png)
...
![](https://s2.loli.net/2025/09/02/zcuKBbfRpg9JEk2.png)
...
![](https://s2.loli.net/2025/09/02/dHpjmI4ngx5cr7k.png)

在 mysql workbench 里可以看到 user 表：

![](https://s2.loli.net/2025/09/02/mSRfxlnZ3IeLOXD.png)
...
![](https://s2.loli.net/2025/09/02/xuLik8CAWESsn3c.png)
...
![](https://s2.loli.net/2025/09/02/73qKa1rV2TtmYZv.png)
...
![](https://s2.loli.net/2025/09/02/nmdOb7UwKchZxyu.png)

我们测试一下：

![](https://s2.loli.net/2025/09/02/17F4mASZwVJxoU3.png)

![](https://s2.loli.net/2025/09/02/rJqugDCUsOyLdzH.png)

鉴权逻辑生效了。

然后我们登录下：

![](https://s2.loli.net/2025/09/02/s9IBP8J2ZvKqClz.png)
...
![](https://s2.loli.net/2025/09/02/zKNrCDZF1OihwUv.png)

refresh_token 失效或者错误时，会返回 401 的响应码，提示需要重新登录：

![](https://s2.loli.net/2025/09/02/MlBH2dXukrEPxYj.png)
...
![](https://s2.loli.net/2025/09/02/HTf6FVKl5RMSyax.png)
...
![](https://s2.loli.net/2025/09/02/D52UJGcrxBHg7vq.png)
...
![](https://s2.loli.net/2025/09/02/5PxHqbOTYN6WK9R.png)

可以看到 /aaa 访问成功，返回了数据，/bbb 返回了 401

![](https://s2.loli.net/2025/09/02/9v8caBxtEju7kwN.png)

这里请求两次是因为 index.tsx 里面有个 React.StrictMode，把它去掉就好了：

![](https://s2.loli.net/2025/09/02/ZCojl5tYwTD7hpE.png)

![](https://s2.loli.net/2025/09/02/lW3sCiHXL62OGT9.png)

### 我们先登录一下，拿到 access_token，然后在请求的时候带上：

![](https://s2.loli.net/2025/09/02/94hmHaIlDk6qXLC.png)
...
![](https://s2.loli.net/2025/09/02/jXbiLaFm5tUqslC.png)

![](https://s2.loli.net/2025/09/02/ucG7ez5Ah9Xl8wS.png)

![](https://s2.loli.net/2025/09/02/EczyQ76eLXCsipK.png)

如果很多接口都要添加这个 header，可以把它放在 interceptors 里做：

![](https://s2.loli.net/2025/09/02/lJg8fNPA4caH2M3.png)
...
![](https://s2.loli.net/2025/09/02/21EFvfeKxO4PWjG.png)
...
![](https://s2.loli.net/2025/09/02/nN4gLK8UpYiz6oC.png)
...
![](https://s2.loli.net/2025/09/02/vJfDmSydAgQEHPx.png)

刷新下页面：

![](https://s2.loli.net/2025/09/02/kShgneyfMH8Qm4b.png)
...
![](https://s2.loli.net/2025/09/02/2MFhbzHR6pnySdB.png)
...
![](https://s2.loli.net/2025/09/02/W4KxQsXLCYmtbOn.png)

确实刷新了多次，并发的 3 次，还有后面又访问了一次：

![](https://s2.loli.net/2025/09/02/BHntWOXgokwJAyx.png)

其实这样不处理也行，多刷几次也不影响功能。

但做的完美点还是要处理下：

![](https://s2.loli.net/2025/09/02/8cEkZusiId3V5QP.png)

![](https://s2.loli.net/2025/09/02/7D9JxmgldtqjLYS.png)
...
![](https://s2.loli.net/2025/09/02/NPi54IV9lezTHLc.png)

现在就只刷新一次 token 了：

![](https://s2.loli.net/2025/09/02/dBA7TW8c5xRMeIv.png)

## 最后，为什么说双 token 会更安全呢？

![](https://s2.loli.net/2025/09/02/WqJ1F9kAvL87Sim.png)
