...
![](https://s2.loli.net/2025/10/15/E5tMkiPmbgcsnAF.png)
...
![](https://s2.loli.net/2025/10/15/iCPbk2SJFgQ1D5y.png)
...
![](https://s2.loli.net/2025/10/15/dm1WhIolM3ipJcy.png)
...
![](https://s2.loli.net/2025/10/15/nUbZQE9dN5eoq6l.png)

可以看到，执行了 create table 的 sql。

![](https://s2.loli.net/2025/10/15/8b9sxFIhOgtp61T.png)
...
![](https://s2.loli.net/2025/10/15/EzyjhiV9oxmlvb8.png)
...
![](https://s2.loli.net/2025/10/15/1a78GyiU3H6gOzF.png)
...
![](https://s2.loli.net/2025/10/15/un3srbjdfqQFkzU.png)

![](https://s2.loli.net/2025/10/15/ovj8nI7ckF39gxB.png)
...
打印了 redis 里的 key：
![](https://s2.loli.net/2025/10/15/EebU9D8pujm2lc3.png)

在 RedisInsight 里看到的也是这些：

![](https://s2.loli.net/2025/10/15/z1esf8KjBxENqgh.png)
...
docker build -t eee .
```
![](https://s2.loli.net/2025/10/15/uW3IbYSid4NUVCK.png)

（我这里稍微有点久，用了 200 多秒）

在 docker desktop 里可以看到这个镜像：

![](https://s2.loli.net/2025/10/15/bu9c8I5daoRLTwq.png)

### 那假设在服务器上，要怎么部署这个 nest 应用呢？

我们先把 mysql、redis 的容器停掉。

![](https://s2.loli.net/2025/10/15/zmPxtw1CRMQgUFy.png)

![](https://s2.loli.net/2025/10/15/FoxwHS7U6e9Jtqb.png)
...
![](https://s2.loli.net/2025/10/15/y9mvU5Jbh8ngikQ.png)
...
![](https://s2.loli.net/2025/10/15/mniKBIVltTqo8Nw.png)
...
![](https://s2.loli.net/2025/10/15/r12FGz8oJjUxkQO.png)
...
```
![](https://s2.loli.net/2025/10/15/xnj2k1SXKyV3iB7.png)
```
docker logs redis-container
```

![](https://s2.loli.net/2025/10/15/rdNwZk4IUtCMAyB.png)

```
docker logs nest-container
```

![](https://s2.loli.net/2025/10/15/SY269EeykDULsMq.png)
...
![](https://s2.loli.net/2025/10/15/ESZKFPdi2RxmnpD.png)

然后把 AppModule 里的 redis 和 mysql 连接信息改一下：

![](https://s2.loli.net/2025/10/15/nax5DCdeG9wTXpU.png)
...
![](https://s2.loli.net/2025/10/15/c52zTIgCQEDApWL.png)
...
```
![](https://s2.loli.net/2025/10/15/yfJUPNAzxRqCb3m.png)

然后在数据库里把 aaa这个表删掉：

![](https://s2.loli.net/2025/10/15/gEXMOjNx9uZLT7w.png)
...
![](https://s2.loli.net/2025/10/15/DHl2e1stiMnpNYS.png)
...
![](https://s2.loli.net/2025/10/15/P5B8AIT9cWK3hFN.png)
...
![image.png](https://s2.loli.net/2025/10/15/2ROAuXno84hFc3a.png)

浏览器访问下 http://localhost:3000

![image.png](https://s2.loli.net/2025/10/15/XliBRpCA3aDqTEt.png)

再次 docker logs 看看：

![image.png](https://s2.loli.net/2025/10/15/XfyLG3C28OEBTng.png)
...
![](https://s2.loli.net/2025/10/15/QGStR6OVeLcshvq.png)
...
![](https://s2.loli.net/2025/10/15/vFTjXVc7UlSmGd5.png)
...
![](https://s2.loli.net/2025/10/15/8lAntrJqEwZRbsi.png)

浏览器访问下 http://localhost:3000


![](https://s2.loli.net/2025/10/15/bvzre7dMt3aOYJB.png)

可以看到 redis 也连接成功了：

![](https://s2.loli.net/2025/10/15/whdsK63cky9Oiau.png)
...
![](https://s2.loli.net/2025/10/15/jY7VbMKJ9lcGEBz.png)
